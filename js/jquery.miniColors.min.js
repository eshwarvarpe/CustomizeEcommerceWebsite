    ...
    $.extend($.fn, {
      miniColors: function (o, data) {
        var create = function (input, o, data) {
          ...
          if (alpha < 0) alpha = 0;
          var trigger = $(
            '<a class="miniColors-trigger" style="background-color: #' +
              color +
              '" href="#"></a>'
          );
          ...
          input
            ...
            .data(
              "letterCase",
              o.letterCase === "uppercase" ? "uppercase" : "lowercase"
            )
          ...
          if (o.readonly || input.prop("readonly"))
          ...
          input.on("blur.miniColors", function (event) {
            ...
            input.val(
              hex ? "#" + convertCase(hex, input.data("letterCase")) : ""
            );
          });
        ...
        var show = function (input) {
          ...
          selector
            .append(
              '<div class="miniColors-hues"><div class="miniColors-huePicker"></div></div>'
            )
            .append(
              '<div class="miniColors-colors" style="background-color: #FFF;"><div class="miniColors-colorPicker"><div class="miniColors-colorPicker-inner"></div></div>'
            )
            .css("display", "none")
          ...
          if (input.data("opacity")) {
            selector
              .addClass("opacity")
              .prepend(
                '<div class="miniColors-opacity"><div class="miniColors-opacityPicker"></div></div>'
              );
          }
          ...
          selector
            ...
            .css(
              "backgroundColor",
              "#" + hsb2hex({ h: hsb.h, s: hsb.s, b: hsb.b })
            )
            .end();
          ...
          if (!opacityPosition)
            opacityPosition = getOpacityPositionFromAlpha(
              input.attr("data-opacity")
            );
          selector
            .find(".miniColors-opacityPicker")
          ...
          if (top + selectorHeight > windowHeight + scrollTop)
            top = top - selectorHeight - triggerHeight;
          if (left + selectorWidth > windowWidth + scrollLeft)
            left = left - selectorWidth + triggerWidth;
        ...
        var moveColor = function (input, event) {
          ...
          position.x =
            position.x -
            input.data("selector").find(".miniColors-colors").offset().left -
            6;
          position.y =
            position.y -
            input.data("selector").find(".miniColors-colors").offset().top -
            6;
        ...
        var setColor = function (input, hsb, updateInput) {
          ...
          if (input.data("change")) {
            if (
              hex + "," + input.attr("data-opacity") ===
              input.data("lastChange")
            )
              return;
            input
              .data("change")
        ...
        var setColorFromInput = function (input) {
          ...
          var opacityPosition = getOpacityPositionFromAlpha(
            input.attr("data-opacity")
          );
          var opacityPicker = $(input.data("opacityPicker"));
        ...
        switch (o) {
          ...
          case "value":
            if (data === undefined) {
              ...
              return hex
                ? "#" + convertCase(hex, input.data("letterCase"))
                : null;
            }
            $(this).each(function () {
              if (!$(this).hasClass("miniColors")) return;
